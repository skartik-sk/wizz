  ...
  return (
    <div className="flex flex-col space-y-2 ">
      <button
        ...
        className={`${activeBtn == 1 ? activ : inactiv} `}
      >
      ...
      <button
        ...
        className={`${activeBtn == 2 ? activ : inactiv} `}
      >
        <div className="flex space-x-3 p-2 px-3  font-medium ">
          <div className="flex flex-col justify-center">
            {" "}
      ...
      <button
        ...
        className={`${activeBtn == 3 ? activ : inactiv} `}
      >
        <div className="flex space-x-3 p-2 px-3  font-medium ">
          <div className="flex flex-col justify-center">
            {" "}
      ...
      <button
        ...
        className={`${activeBtn == 4 ? activ : inactiv} `}
      >
        <div className="flex space-x-3 p-2 px-3  font-medium ">
          <div className="flex flex-col justify-center">
            {" "}
      ...
      <button
        ...
        className={`${activeBtn == 5 ? activ : inactiv} `}
      >
        <div className="flex space-x-3 p-2 px-3  font-medium ">
          <div className="flex flex-col justify-center">
            {" "}
