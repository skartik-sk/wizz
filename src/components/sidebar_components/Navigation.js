...
const Navigation = () => {
  ...
  const activ = "bg-[#7501E9] w-[90%] text-[#D1D1D1] text-opacity-90   px-2   text-lg  border-none  rounded-lg text-left"
  const inactiv = "px-2 w-full text-lg  text-[#D1D1D1] text-opacity-90  border-none  rounded-xl text-left"
  return (
    <div className="flex flex-col space-y-2 ">
          <button  onClick={() => handleBtnClick(1)} className= { `${activeBtn==1 ? activ  : inactiv } ` } >
          ...
          <button  onClick={() => handleBtnClick(2)} className= {`${activeBtn==2 ? activ  : inactiv } ` } >
            <div className="flex space-x-3 p-3  font-medium ">
              <div className="flex flex-col justify-center">
                {" "}
                <svg
          ...
          <button  onClick={() => handleBtnClick(3)} className= {`${activeBtn==3 ? activ  : inactiv } ` } >
            <div className="flex space-x-3 p-3  font-medium ">
              <div className="flex flex-col justify-center">
                {" "}
                <svg
          ...
          <button  onClick={() => handleBtnClick(4)} className= {`${activeBtn==4 ? activ  : inactiv } ` } >
            <div className="flex space-x-3 p-3  font-medium ">
              <div className="flex flex-col justify-center">
                {" "}
                <svg
          ...
          <button  onClick={() => handleBtnClick(5)} className= {`${activeBtn==5 ? activ  : inactiv } ` } >
            <div className="flex space-x-3 p-3  font-medium ">
              <div className="flex flex-col justify-center">
                {" "}
                <svg
