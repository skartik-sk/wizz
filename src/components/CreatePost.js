...
const CreatePost = ({ setClicked }) => {
  ...
  return (
    <div className="w-[65%] flex flex-col align-middle my-3 h-full  ">
      <div className="fixed bottom-0 bg-black rounded-t-3xl w-[33%] p-6 ">
        ...
        <div className="flex flex-col space-y-3 p-4 ">
          ...
          <div>
            <textarea name="" id="" placeholder="| Add your Caption" className="p-3 rounded-xl bg-[#1F212D] w-full h-36 text-white"></textarea>
          </div>
          <div>
          <div class="max-w-lg l ">
  <div class="relative">
    <input class="appearance-none block w-full bg-[#1F212D] w-ful text-white rounded py-2 px-4 leading-tight focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter some tags"/>
    <div class="hidden">
      <div class="absolute z-40 left-0  w-full">
        <div class=" text-sm bg-white rounded shadow-lg border border-gray-300">
          <a class="block  cursor-pointer hover:bg-indigo-600 hover:text-white">Add tag <span class="font-semibold" x-text="textInput"></span></a>
        </div>
      </div>
    </div>
...
<path d="M12.0729 0.174805H14.6579V10.5149H12.0729V0.174805ZM9.48787 0.174805H0.871094V10.5149H9.48787V5.34487H6.90284V7.92991H3.45613V2.75984H9.48787V0.174805ZM24.9981 2.75984V0.174805H17.243V10.5149H19.828V7.06823H23.2747V4.48319H19.828V2.75984H24.9981Z" fill="#999999"/>
</svg>
